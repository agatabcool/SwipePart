...
//        contentImage.image = [UIImage imageNamed:@"nycme"];
//        [contentView addSubview:contentImage];
        
        exampleCardLabels =[[NSArray alloc]initWithObjects:@"first1",@"second",@"third",@"fourth",@"last", nil]; //%%% placeholder for card-specific information
        //[self defaultPeople];
...
-(DraggableView *)createDraggableViewWithDataAtIndex:(NSInteger)index
{
   ...
   // draggableView.photoinfo  = [[UIImageView alloc] initWithImage :
...
-(void)cardSwipedLeft:(UIView *)card;
{
    ...
    if (cardsLoadedIndex < [allCards count]) { //%%% if we haven't reached the end of all cards, put another into the
